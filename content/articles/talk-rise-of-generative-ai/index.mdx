...
- Transformers were originally built for for NLP, computer vision, graph-structured data, etc
...
<Figure caption="A surreal wide angle cinematic shot of a steampunk cityscape with towering metallic buildings, and floating objects, creating a dreamlike and disorienting atmosphere. SD 1.4, Steps: 20, Sampler: Euler a, CFG scale: 7, Seed: 4016536929">

![A surreal wide angle cinematic shot of a steampunk cityscape with towering metallic buildings, and floating objects, creating a dreamlike and disorienting atmosphere. SD 1.4, Steps: 20, Sampler: Euler a, CFG scale: 7, Seed: 4016536929](./cityscape.png)
...
In my personal opinion, AI is the perfect tool to augment human capabilities. Expect another major avalanche of innovation when these technologies "shrink" to fit in our pockets.
